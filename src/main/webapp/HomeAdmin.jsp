        ...
        <div class="top"> <!-- top -->
            <div class="container">
                <ul class="top-support">
                    <li><i class="fa fa-phone-square"></i><span>(+84) 123 456 7890</span></li>
                ...
                <div class="top-control"><a href="">Check User</a><span>•</span>
                    <a href="">Track Order</a><span>•</span><a href="">ADMIN</a><span>•</span><a
                            href="/HomeUser">Logout</a>
                    ...
                    <nav class="navbar navbar-default">
                        ...
                        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                            ...
                            <ul class="nav navbar-nav navbar-right">
                                ...
                                <li><label><a href="/HomeAdmin.jsp"><img src="images/bag.png"
                                                                         alt="bag"><span>dong 100</span></a></label>
                                </li>
                ...
                <div class="newest-content">
                    <div class="newest-tab">
                        <ul id="myTab" class="nav nav-tabs newest" role="tablist">
                            <li>
                                <a type="button" class="btn btn-primary" style="color: #080808" href="/AddProduct.jsp">ADD PRODUCT</a>
                            </li>
                            <li role="presentation" class="active"><a href="#1" id="cat-1" role="tab" data-toggle="tab"
                                                                      aria-controls="1"
                                                                      aria-expanded="true">Featured</a></li>
                            <li role="presentation"><a href="#2" role="tab" id="cat-2" data-toggle="tab"
                                                       aria-controls="2">New Arrivals</a></li>
                            <li role="presentation"><a href="#3" role="tab" id="cat-3" data-toggle="tab"
                                                       aria-controls="3">Best Seller</a></li>
                        </ul>
                        <div class="">
                            <div class="row">
                                <c:forEach items="${sanphams}" var="o">
                                    <div class="col-md-4 prdct-grid">
                                            ...
                                            <div class="product-fade-wrap">
                                                ...
                                                <div class="product-fade-ct">
                                                    <div class="product-fade-control">
                                                        ...
                                                        <div class="clearfix"></div>
                                                        <a href="/addCart?id=${o.id_Product}" class="btn btn-to-cart"><span
                                        ...
                                        <a style="position: relative" type="button" class="btn btn-danger"  href="/delete?id=${o.id_Product}">Delete</a>
                                    </div>
                                </c:forEach>
                            </div>
                        </div>
