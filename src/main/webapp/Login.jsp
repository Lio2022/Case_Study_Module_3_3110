...
<section>
    ...
    <div class="img-bg">
        <img src="https://cdn.pixabay.com/photo/2017/08/06/17/58/people-2594683_960_720.jpg" alt="Hình Ảnh Minh Họa">
    </div>
    <!--Kết Thúc Phần Hình Ảnh-->
    <!--Bắt Đầu Phần Nội Dung-->
    <div class="noi-dung">
        <div class="form">
            <h2>Login with Manually</h2>
            <form action="/Login" method="post">
                ...
                <div class="nho-dang-nhap">
                    <label><input type="checkbox" name=""> Keep me signed in</label>
                </div>
                <div class="input-form">
                    <input type="submit" value="SIGN IN">
                </div>
                <div class="input-form">
                    <p>Don't have an account? <a href="/Register.jsp">Get Started</a></p>
                </div>
            </form>
